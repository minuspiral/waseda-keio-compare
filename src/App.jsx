      ...
      <div style={{maxWidth:1120,margin:"0 auto"}}>
        ...
        {tab==="composition"&&(<div>
          ...
          <div style={{background:"rgba(74,144,217,0.04)",borderRadius:12,padding:"14px",border:"1px solid rgba(74,144,217,0.1)",fontSize:13,lineHeight:1.8,color:"#8899bb"}}>
            ...
            国立大は併願不可のためボーダー付近に分布が集中し、上位・下位とも極端に薄い。河合塾全統模試の実データでは、<b style={{color:"#4466BB"}}>慶應理工入学者の分布は下位層が阪大理工系(平均63.9)の分布域に近接し、上位層が東工大(平均66.8)の分布と重なる幅広い学力帯</b>となっている。合格者平均68.6から入学者平均65.9への低下は、この幅広さに起因する。詳細は「国公立との比較」タブを参照。</div>
        </div>)}
        ...
        {tab==="national"&&(<div>
          ...
          <div style={{background:"rgba(46,204,113,0.04)",borderRadius:12,padding:"14px",border:"1px solid rgba(46,204,113,0.1)",fontSize:13,lineHeight:1.8,color:"#9aab99"}}>
            ...
            <b style={{color:"#4466BB"}}>慶應理工入学者の分布は、上位層が東工大と重なり、下位層が阪大理工系に近接する幅広い学力帯。</b>合格者平均は68.6だが、上位層（東大落ち70+）の多くが浪人を選ぶため入学者は65-68帯に集中し、平均は65.9に低下する。この入学者分布は東工大合格者(平均66.8)の分布と大きく重複する一方、下位層では阪大理工系(平均63.9)の上位側に近接する。<br/><br/>
